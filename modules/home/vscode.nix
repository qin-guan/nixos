...

{
  programs.vscode = {
    ...
    profiles.default.userSettings = {
      ...
      "vscode-neovim.ctrlKeysForInsertMode" = [ "w" ];
      "vscode-neovim.ctrlKeysForNormalMode" = [ "w" ];
      "editor.cursorSmoothCaretAnimation" = "on";
      "editor.fontFamily" = "Maple Mono NF CN, Cascadia Code NF, Jetbrains Mono, Input Mono, Fira Code, monospace";
      ...
      "terminal.integrated.fontFamily" = "Maple Mono NF CN, Cascadia Code NF, Jetbrains Mono, Input Mono, Fira Code, monospace";
